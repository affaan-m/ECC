...
**搞定！** 你现在可以使用 72 个智能体、283 项技能和 94 个命令了。
...
|---------|---------------|----------|--------|
| 智能体 | PASS: 72 个    | PASS: 12 个 | **Claude Code 领先** |
| 命令 | PASS: 94 个    | PASS: 35 个 | **Claude Code 领先** |
| 技能 | PASS: 283 项   | PASS: 37 项 | **Claude Code 领先** |
...
|---------|-----------------------|------------|-----------|----------|
| **智能体** | 72                    | 共享 (AGENTS.md) | 共享 (AGENTS.md) | 12 |
| **命令** | 94                    | 共享 | 基于指令 | 35 |
| **技能** | 283                   | 共享 | 10 (原生格式) | 37 |
