...
**That's it!** You now have access to 68 agents, 279 skills, and 94 legacy command shims.
...
| Skills | 39 | `.agents/skills/` — SKILL.md + agents/openai.yaml per skill |
...
| analyst-ops | Source-backed analyst readouts and metric contracts |
...
|---------|---------------------|----------|--------|
| Agents | PASS: 68 agents     | PASS: 12 agents | **Claude Code leads** |
...
|---------|-----------------------|------------|-----------|----------|----------------|
| **Agents** | 68                    | Shared (AGENTS.md) | Shared (AGENTS.md) | 12 | N/A |
