# ECC for Hermes — Agent Instructions

This is the Hermes harness configuration for ECC (Everything Claude Code).
...
| spec-miner | Brownfield spec extraction | Onboarding brownfield projects |
