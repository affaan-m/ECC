...
**That's it!** You now have access to 67 agents, 272 skills, and 92 legacy command shims.
...
| browser-use | Autonomous cloud-browser AI agent — scrape, fill forms, multi-step web tasks via MCP or SDK |
...
| Skills | PASS: 272 skills    | PASS: 37 skills | **Claude Code leads** |
...
| **Skills** | 272                   | Shared | 10 (native format) | 37 | Via instructions |
