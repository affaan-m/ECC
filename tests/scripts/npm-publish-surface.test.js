  ...
  const tests = [
    ...
    ["npm pack publishes the reduced runtime surface", () => {
      ...
      for (const requiredPath of [
        ...
        "plugins/ecc/assets/ecc-icon.svg",
        "plugins/ecc/assets/hero.png",
        "plugins/ecc/skills/tdd-workflow/SKILL.md",
        "plugins/ecc/skills/tdd-workflow/agents/openai.yaml",
        "plugins/ecc/skills/prompt-optimizer/SKILL.md",
        "plugins/everything-codex/.codex-plugin/plugin.json",
        "plugins/everything-codex/.mcp.json",
        "plugins/everything-codex/assets/ecc-icon.svg",
        "plugins/everything-codex/assets/hero.png",
        "plugins/everything-codex/skills/tdd-workflow/SKILL.md",
        "plugins/everything-codex/skills/tdd-workflow/agents/openai.yaml",
        "plugins/everything-codex/skills/prompt-optimizer/SKILL.md",
        "assets/ecc-icon.svg",
        "assets/hero.png",
